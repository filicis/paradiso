...
/**
* External Module for Webtrees 2.0
* Copyright (C) 2020 Michael Lindhardt Rasmussen
*
...
/**
* Krige og konflikter der involverede Danmark (fra Felttoget i Ditmarsken år 1500 til Besættelsen 1940-45)
*/
...
return new class extends AbstractModule implements ModuleCustomInterface, ModuleHistoricEventsInterface
{
  ...
  */
  ...
  {
    return 'Danske Krige og konflikter';
  }
  ...
  */
  public function isEnabledByDefault(): bool
  {
    ...
    {
        return 'https://github.com/filicis/paradiso/';
    }
...
/*
    ...
    "1 EVEN Frederik 6.\n2 TYPE Danske Regenter\n2 DATE FROM 13 MAR 1808 TO 3 DEC 1839\n2 NOTE Regent 14. april 1784 ved Christian 7.s sygdom, Konge 13. marts 1808 ved dennes død Se [Danmarkshistorien](https://danmarkshistorien.dk/leksikon-og-kilder/vis/materiale/frederik-6-1768-1839/) ",
...
*/
    ...
    "1 EVEN Københavns bombardement\n2 TYPE Danske Krige\n2 DATE 1807\n2 NOTE Tabet af flåden",
    ...
    "1 EVEN Besættelsen\n2 TYPE Danske Krige\n2 DATE FROM 9 APR 1940 TO 5 MAY 1945\n2 NOTE ",
      ...
      /*
          Epidemier i bred forstand
      */
/*
    "1 EVEN Pestudbrud i København\n2 TYPE Epidemier\n2 DATE 1625 \n2 , se [Danmarkshistorien](https://danmarkshistorien.dk/leksikon-og-kilder/vis/materiale/christian-4s-pestforordning-1625/)",
    "1 EVEN Pest\n2 TYPE Epidemier\n2 DATE 1652 \n2 , se [Danmarkshistorien](https://danmarkshistorien.dk/leksikon-og-kilder/vis/materiale/begravelsesforordning-under-pesten-17-august-1652-og-27-maj-1654/)",

    "1 EVEN Pest\n2 TYPE Epidemier\n2 DATE 1711 \n2 , se [Wikipedia]()",
    "1 EVEN Forordning om Koppevaccination\n2 TYPE Epidemier\n2 DATE 3 APR 1810\n2 NOTE  Se [Danmarkshistorien](https://danmarkshistorien.dk/leksikon-og-kilder/vis/materiale/forordning-om-koppevaccination-1810/)",

    "1 EVEN Kolera\n2 TYPE Epidemier\n2 DATE 1853 \n2 NOTE , se [Wikipedia](https://da.wikipedia.org/wiki/Den_spanske_syge)",
